...
Item {
    ...
    ListView {
        ...
        Component.onCompleted: {
            ...
            model.append({"identifier": Papyrus.GoogleMap ,"name": qsTr("Google Map")})
            model.append({"identifier": Papyrus.OpenStreetMap ,"name": qsTr("OpenStreet Map")})
